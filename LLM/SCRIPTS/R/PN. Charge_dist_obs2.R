...
# Guardar gráfico
ggsave(plot = high, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PDF/charge_dist_high.pdf",
       device = "pdf", width = 3, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(plot = high, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PNG/charge_dist_high.png",
...
# Guardar gráfico
ggsave(plot = med, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PDF/charge_dist_medium.pdf",
       device = "pdf", width = 3, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(plot = med, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PNG/charge_dist_medium.png",
       device = "png", width = 3, height = 4, units = "in", dpi = 400)
...
# Guardar gráfico
ggsave(plot = low, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PDF/charge_dist_low.pdf",
       device = "pdf", width = 3, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(plot = low, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PNG/charge_dist_low.png",
       device = "png", width = 3, height = 4, units = "in", dpi = 400)
...
# Juntar gráficos
p <- ggarrange(high, med, low, ncol = 3, nrow = 1)


# Guardar gráfico
ggsave(plot = p, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PDF/charge_dist_all.pdf",
       device = "pdf", width = 7, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(plot = p, filename = "/media/kaz-bits/TOSHIBA EXT/ALL/Project_NN_proteins/PLOTS/obs/PNG/charge_dist_all.png",
       device = "png", width = 7, height = 4, units = "in", dpi = 400)
