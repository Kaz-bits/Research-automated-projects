...
df_fret_200_delta <- read.csv(file = "C:/Users/HP/Desktop/FRET R SCRIPTS/Datos3D/FRET_delta_200.csv", 
                              header = TRUE)

# Cargar archivo de datos de CIDER
df_fret_200_cider <- readxl::read_excel(path = "C:/Users/HP/Desktop/FRET R SCRIPTS/Datos3D/CIDER _Biblioteca.xlsx", 
