...
#cargar el archivo solo con la hoja 1 (datos)----
fret <- readxl::read_xlsx(path = "DATA/DATA FOR R/FRET/Data_FRET/IDRFT_REP2_P1. ALTA. N1.xlsx", 
...
temp_df <- data.frame(matrix(ncol = 4, nrow = nrow(fret)))
...
temp <- (t(temp_fret[temp_fret[,1] == as.character(533),
...
write.table(x = temp_fret_N, 
            file = "DATA/DATA FOR R/FRET/Data_FRET/IDRFT_REP1_P1.ALTA.N1.A.txt",
...
spectra_fret(construct = 1, name_plot = "IDRBS-081", 
            save_spectra = F)
spectra_fret(construct = 5, name_plot = "IDRBS-144", 
             save_spectra = F)

#Alta
spectra_fret(construct = 1, save_spectra = F, 
             name_spectra = "IDRFT_081_spectra", 
             name_plot = "IDRBS-081",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 5, save_spectra = T, 
             name_spectra = "IDRFT_082_spectra",
             name_plot = "IDRBS-082",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 9, save_spectra = T, 
             name_spectra = "IDRFT_137_spectra", 
             name_plot = "IDRBS-137",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 13, save_spectra = T, 
             name_spectra = "IDRFT_138_spectra",
             name_plot = "IDRBS-138",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 17, save_spectra = T, 
             name_spectra = "IDRFT_143_spectra",
             name_plot = "IDRBS-143",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 21, save_spectra = T, 
             name_spectra = "IDRFT_144_spectra",
             name_plot = "IDRBS-144",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 25, save_spectra = T, 
             name_spectra = "IDRFT_145_spectra",
             name_plot = "IDRBS-145",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 29, save_spectra = T, 
             name_spectra = "IDRFT_146_spectra",
             name_plot = "IDRBS-146",
             dir_spectra = "PLOTS/FRET/Spectrum/Spectrum_new/")
spectra_fret(construct = 1, save_spectra = T, 
...
fret_boxplot <- function(rep1, name_plot, save_box, 
  ...
  plot <- ggplot() + 
    ...
    geom_jitter(data = temp_rep1[c(rep1:(rep1+12-(1))), c(1,6)], 
                aes(x = Tratamiento, 
                    y = Normalización, group = Tratamiento)) +
    ...
    annotate(geom = "text", x = 0.5, y = 2.4, 
             label = p1_box, size = 4.5) +
    annotate(geom = "text", x = 1, y = 2.4, 
             label = p2_box, size = 4.5) +
    annotate(geom = "text", x = 1.5, y = 2.4, 
             label = p3_box, size = 4.5)  +
    annotate(geom = "text", x = 0.75, y = 2.8, 
             label = name_plot,
             size = 5)
  #Guardar gráfico
  if (save_box == TRUE) {
...
fret_boxplot(rep1 = 1, name_plot = "IDRBS_081", save_box = F)
#Alta
fret_boxplot(rep1 = 1, name_plot = "IDRBS-081", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_081_box")
fret_boxplot(rep1 = 13, name_plot = "IDRBS-082", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_082_box")
fret_boxplot(rep1 = 25, name_plot = "IDRBS-137", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_137_box")
fret_boxplot(rep1 = 37, name_plot = "IDRBS-138", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_138_box")
fret_boxplot(rep1 = 49, name_plot = "IDRBS-143", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_143_box")
fret_boxplot(rep1 = 61, name_plot = "IDRBS-144", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_144_box")
fret_boxplot(rep1 = 73, name_plot = "IDRBS-145", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_145_box")
fret_boxplot(rep1 = 85, name_plot = "IDRBS-146", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_146_box")
fret_boxplot(rep1 = 1, name_plot = "IDRBS-165", save_box = TRUE, 
             dir_box = "PLOTS/FRET/Boxplots/new_box/", 
             name_box = "IDRFT_165_box")
