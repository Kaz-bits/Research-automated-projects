...
# Crear data frames para los grupos del diagrama de estados
...
# Crear vector de ejes numéricos
...
# Guardar gráfico 
ggsave(filename = "D:/ME/ALL/Project_IDP_D2P2/PLOTS/LOCALCIDER/diagram_of_staes.pdf", 
       device = "pdf", width = 6, height = 5, units = "in", dpi = 450)

# Guardar gráfico 
ggsave(filename = "D:/ME/ALL/Project_IDP_D2P2/PLOTS/LOCALCIDER/diagram_of_staes.png", 
