...
df_fret_200_delta <- read.table(file = "/media/kazbits/TOSHIBA EXT/ALL/Project_IDP_D2P2/DATA/BASES DE DATOS/delta_seq_parrot.tsv", 
                                header = TRUE, sep = "\t")
...
temp_list <- list.files("/media/kazbits/TOSHIBA EXT/NCPR/NCPR_Constanza/")
...
for (i in temp_list_high) {
  ...
  # Cargar archivo
  temp <- read.csv(file = file.path("/media/kazbits/TOSHIBA EXT/NCPR/NCPR_Constanza", i))
