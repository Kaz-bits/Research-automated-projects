...
df_fret_200 <- read.csv(file = "D:/Project_IDP_D2P2/DATA/DATA FOR R/FRET/Data_FRET/COMPLETE_DATA/LIBRARY/FRET_delta_200.csv",
                        header = TRUE)

# Cargar archivo de datos de CIDER
df_fret_200_cider <- readxl::read_excel(path = "D:/Project_IDP_D2P2/DATA/DATA FOR R/FRET/Data_FRET/COMPLETE_DATA/LIBRARY/CIDER _Biblioteca.xlsx", 
